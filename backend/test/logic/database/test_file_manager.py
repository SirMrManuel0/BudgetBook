...
def test_write():
    manager = FileManager(test=True)
    manager.force_directory_path = "backend/permanent_storage/test/file_manager_test/"
...
def test_read():
    manager = FileManager(test=True)
    manager.force_file_path = "backend/permanent_storage/test/file_manager_test/test_w_validator"
